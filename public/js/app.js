...
window.loadAlertProgressIndicator = function () {
  var currentMillis = Date.now();
  var timeOutTime = 5000;
  var indicateLoader = setInterval(function () {
    var diff = Date.now() - currentMillis;
    var percentage = 100 - diff / timeOutTime * 100;
