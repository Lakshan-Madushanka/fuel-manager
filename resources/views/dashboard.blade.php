    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="flex justify-between">
                ...
                <p>
                    <span class="italic inline-block mr-20 text-sm">
                        Fuel consumption
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-4 inline-block" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd"
